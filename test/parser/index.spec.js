...
describe('parser', function() {
  ...
  describe('Given a full example to parse', function() {
    ...
    return it('names each set correctly', function() {
  ...
  describe('given a Set Name to parse', function() {
    ...
    return it('returns a workout with time of 0', function() {
  ...
  describe('given interval with time (100 Swim @ :30) to parse', function() {
    ...
    return describe('generated interval', function() {
      ...
      return it('had valid time', function() {
  ...
  describe('given intervalSet (4x100 Swim @ 1:30) to parse', function() {
    ...
    return describe('when looking at the current set', function() {
      var generatedSet;
      generatedSet = null;
      beforeEach(function() {
      ...
      return it('returns a workout with a set and swim intervals', function() {
  ...
  describe('given full set to parse', function() {
    ...
    return it('returns a workout with 7 intervals', function() {
      var generatedSet;
      generatedSet = workout.current();
      return expect(generatedSet.totalIntervals()).to.eq(7);
    });
  });
  return describe('given two sets to parse', function() {
    beforeEach(function() {
    ...
    describe('the workout', function() {
      ...
      return it('has a total time of 40 minutes', function() {
    ...
    describe('the first set', function() {
      ...
      return it('has a distance of 500', function() {
        return expect(warmUp.totalDistance()).to.eq(500);
      });
    });
    return describe('the second set', function() {
      var mainSet;
      mainSet = null;
      beforeEach(function() {
      ...
      return it('has a distance of 1400', function() {
