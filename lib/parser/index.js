var moment, parseLine, parser, processTokens, tokenActions, workout, _;
...
processTokens = function(tokens, work) {
  var currentSet, name, newTokens, numStartTokens, rest, token, _results;
  ...
  while (tokens.length > 0) {
    ...
    if (token.isEmpty()) {
      ...
      _results.push(currentSet.setDistance(tokenActions.getNumber(token)));
      ...
      _results.push(currentSet.setRest(moment.duration("00:" + rest)));
    } else {
